...
shinyUI(fluidPage(
    ...
    sidebarLayout(
        sidebarPanel(
            radioButtons(inputId = "modelingtype", label = "Regression option:",
                         choiceNames = c("Select best model","Select variables"),
                         choiceValues = c("bestop","customop"))
        ),
        mainPanel(
...
#         sidebarPanel(
#             h2("Inputs"),
#             radioButtons(inputId = "modelingtype", 
#                          label = "Regression option:", 
#                          choiceNames = c("Select best model","Select variables"),
#                          choiceValues = c("bestop","customop"))#,
